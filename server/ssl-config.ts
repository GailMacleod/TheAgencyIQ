...
export const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.stripe.com https://js.stripe.com https://www.googletagmanager.com https://replit.com https://*.replit.app; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com data:; img-src 'self' data: https: blob:; connect-src 'self' https://api.stripe.com https://api.x.ai https://checkout.stripe.com https://graph.facebook.com https://api.instagram.com https://api.linkedin.com https://api.twitter.com https://www.googleapis.com https://oauth2.googleapis.com https://accounts.google.com https://*.replit.app wss://app.theagencyiq.ai wss://*.replit.app; frame-src https://checkout.stripe.com https://js.stripe.com https://accounts.google.com;",
