          ...
          <div className="flex flex-col items-center justify-center text-center space-y-4 sm:space-y-8">
            <div className="space-y-3 sm:space-y-6 animate-fade-in-up max-w-4xl w-full">
              <div className="space-y-2 sm:space-y-4">
                ...
                <h2 className="text-lg sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#3250fa] to-[#00f0ff] bg-clip-text text-transparent leading-loose sm:leading-relaxed px-2">
