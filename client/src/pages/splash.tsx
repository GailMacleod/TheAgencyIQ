            ...
            <div className="space-y-6 animate-fade-in-up max-w-4xl">
              <div className="space-y-4">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                  <span className="block bg-gradient-atomiq bg-clip-text text-transparent">Set & forget</span>
                  <span className="block bg-gradient-atomiq bg-clip-text text-transparent">social media for small businesses</span>
                </h1>
