        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Start automating your social media today with our AI-powered platform designed for Queensland businesses.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-2xl p-8 border border-border hover:shadow-lg transition-shadow">
              <div className="text-center mb-8">
                ...
                <div className="mb-4">
                  <span className="text-4xl font-bold">A$19.99</span>
                  <span className="text-muted-foreground">/month</span>
                </div>
                <p className="text-sm text-muted-foreground">12 posts (10 + 2 free)</p>
              </div>
              ...
              <Link href="/subscription?plan=starter">
            ...
            {/* Growth Plan */}
            <div className="bg-card rounded-2xl p-8 border-2 border-primary hover:shadow-lg transition-shadow relative">
              ...
              <div className="text-center mb-8">
                ...
                <div className="mb-4">
                  <span className="text-4xl font-bold">A$41.99</span>
                  <span className="text-muted-foreground">/month</span>
                </div>
                <p className="text-sm text-muted-foreground">27 posts (25 + 2 free)</p>
              </div>
              ...
              <Link href="/subscription?plan=growth">
                <Button className="w-full bg-primary hover:bg-primary/90 text-white py-3">
                  Get Started
                </Button>
              </Link>
            ...
            <div className="bg-card rounded-2xl p-8 border border-border hover:shadow-lg transition-shadow">
              <div className="text-center mb-8">
                ...
                <div className="mb-4">
                  <span className="text-4xl font-bold">A$99.99</span>
                  <span className="text-muted-foreground">/month</span>
                </div>
                <p className="text-sm text-muted-foreground">52 posts (50 + 2 free)</p>
              </div>
              ...
              <Link href="/subscription?plan=professional">
                <Button className="w-full bg-primary hover:bg-primary/90 text-white py-3">
                  Get Started
                </Button>
              </Link>
