...
## Recent Changes
- **June 25, 2025 11:37 PM**: FACEBOOK OAUTH FIXED - Implemented direct Facebook OAuth handler with long-lived token exchange, app secret proof generation, and automatic connection storage to resolve expired token issue
